# Process used to bootstrap React app development
In theory, we shouldn't have to redo it, but I rather take my precautions.
To bootstrap this micro-environment, I used the following command.
```shell
